...
class SharePage extends Component {
    ...
    render() {
        ...
        return (
                <div>
                    <MyNavbar />
                    <div class='container lightText' style={styles.container}>
                        <h1 class='lightText'>Privacy policy</h1>

                        <p>Share Your Pain built the Share Your Pain app as a freemium app. This SERVICE is provided by Share Your Pain and is intended
                            for use as is.</p>
                        ...
                        <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
                            which is accessible at Share Your Pain, unless otherwise defined in this Privacy Policy.</p>

                        <p><strong>Information Collection and Use</strong></p>
                        <p>For a better experience while using our Service, we may require you to provide us with certain
                            personally identifiable information, including but not limited to name, and email. 
